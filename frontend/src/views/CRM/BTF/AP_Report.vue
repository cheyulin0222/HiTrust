<template >
    ...
    <div class="row p-3" ref = 'search' >
        ...
        <div class=" order-md-1 order-0 col-md-4">
            ...
            <SelectView :options="selOption.acquirerId" :invalidTxt="invalids.acquirerCode "
            @updateVal="updateVal" ref = "acquirerCode " :key="selOption.acquirerId.key"/>
        </div>
        <div class=" order-md-1 order-0 col-md-4">
...
export default {
    ...
    methods : {
        ...
        download(){
            ...
            this.ApiUtil.downloadExcel("/bank-transaction-fee/ap-report/"+acquirerCode+"/"+year+(month<10?"0"+month:month))
            .then(function(){
                _this.showLoading();
            });
        }
