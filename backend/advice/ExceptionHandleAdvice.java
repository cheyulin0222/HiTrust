package com.hitrsutpay.sa.backend.advice;

import static com.hitrsutpay.sa.backend.enums.ErrorType.DATABASE;
import static com.hitrsutpay.sa.backend.enums.ErrorType.REQUEST;
import static com.hitrsutpay.sa.backend.enums.ErrorType.SYSTEM;
...
import com.hitrsutpay.sa.backend.exception.enums.BusinessExceptionDisplay;
import com.hitrsutpay.sa.backend.res.ResponseModel;
import com.hitrsutpay.sa.backend.utils.ClassTool;
...
public class ExceptionHandleAdvice {
	...
	final static Logger logger = LoggerFactory.getLogger(ExceptionHandleAdvice.class);
	...
	public static ResponseModel<String> wrapperExceptionResponse(ErrorType errorType,String data){
		...
		resultResponse.setMessage(errorType.getLable());
		return resultResponse;
	}
